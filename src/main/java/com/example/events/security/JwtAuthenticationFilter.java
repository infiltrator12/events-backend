...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // unauthenticated rather than throwing here. The security
            // filter chain's authorizeHttpRequests rules decide whether
            // an unauthenticated request is allowed through (e.g. public
            // routes) or rejected with 401/403.
            filterChain.doFilter(request, response);
            return;
        }
